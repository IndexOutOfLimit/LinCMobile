...
namespace Cognizant.Hackathon.Shared.Mobile.Models.Models
{
    ...
    public partial class WatsonMessage
    {
        public static WatsonMessage FromJson(string json) => JsonConvert.DeserializeObject<WatsonMessage>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this WatsonMessage self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
